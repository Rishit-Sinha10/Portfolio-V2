  ...
  return (
    <footer className="mt-auto bg-[var(--background)] px-5 pb-5 pt-12 sm:px-7 sm:pt-16">
      <div className="mx-auto max-w-[925px]">
        <div className="flex flex-col gap-6 font-mono text-xs text-[var(--foreground)] md:flex-row md:items-start md:justify-center md:gap-8">
          {/* Contact */}
          {/* Contact */}
          ...
          <nav
            ...
            className="flex flex-wrap items-center gap-x-3 gap-y-3 md:max-w-[650px] md:justify-end"
          >
            <a
